...
# Ecampus Server
A school management web application backend API part. School management software with payment gateway and many other features. It is only the backend API build with graphql, nestjs, expressjs, and apollo server.
...
## Key features
- Created with Graphql and Nodejs and NestJS
